...
print 'Free: %d MB' % ( vmStats["Pages free"]/1024/1024 )
print 'Wired: %d MB' % ( vmStats["Pages wired down"]/1024/1024 )
print 'Active: %d MB' % ( vmStats["Pages active"]/1024/1024 )
print 'Inactive: %d MB' % ( vmStats["Pages inactive"]/1024/1024 )
