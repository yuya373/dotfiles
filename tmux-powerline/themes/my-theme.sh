...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
        TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
                "tmux_session_info ${BG_COLOR} ${GREEN}"
                # "hostname ${BG_COLOR} ${FG_COLOR}"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
        TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
                "pwd ${BG_COLOR} ${CYAN}"
                "vcs_branch ${BG_COLOR} ${FG_COLOR} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
                "lan_ip ${BG_COLOR} ${FG_COLOR} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
                "wan_ip ${BG_COLOR} ${FG_COLOR}"
                #"earthquake 3 0"
